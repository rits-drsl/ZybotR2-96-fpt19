...
## LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L12N_T1_MRCC_16 Sch=led[1]p
...
set_property PULLUP true [get_ports ja[1]]
set_property PULLUP true [get_ports ja[2]]
set_property PULLUP true [get_ports ja[3]]
set_property PULLUP true [get_ports ja[4]]
set_property PULLUP true [get_ports ja[5]]
set_property PULLUP true [get_ports ja[6]]
set_property PULLUP true [get_ports ja[7]]
...
set_property PULLUP true [get_ports pio1]
set_property PULLUP true [get_ports pio2]
set_property PULLUP true [get_ports pio3]
set_property PULLUP true [get_ports pio4]
set_property PULLUP true [get_ports pio5]
set_property PULLUP true [get_ports pio6]
set_property PULLUP true [get_ports pio7]
set_property PULLUP true [get_ports pio8]
set_property PULLUP true [get_ports pio9]
set_property PULLUP true [get_ports pio10]
set_property PULLUP true [get_ports pio11]
set_property PULLUP true [get_ports pio12]
set_property PULLUP true [get_ports pio13]
set_property PULLUP true [get_ports pio14]
set_property PULLUP true [get_ports pio17]
set_property PULLUP true [get_ports pio18]
set_property PULLUP true [get_ports pio19]
set_property PULLUP true [get_ports pio20]
set_property PULLUP true [get_ports pio21]
set_property PULLUP true [get_ports pio22]
set_property PULLUP true [get_ports pio23]
set_property PULLUP true [get_ports pio26]
set_property PULLUP true [get_ports pio27]
set_property PULLUP true [get_ports pio28]
set_property PULLUP true [get_ports pio29]
set_property PULLUP true [get_ports pio30]
set_property PULLUP true [get_ports pio31]
set_property PULLUP true [get_ports pio32]
set_property PULLUP true [get_ports pio33]
set_property PULLUP true [get_ports pio34]
set_property PULLUP true [get_ports pio35]
set_property PULLUP true [get_ports pio36]
set_property PULLUP true [get_ports pio37]
set_property PULLUP true [get_ports pio38]
set_property PULLUP true [get_ports pio39]
set_property PULLUP true [get_ports pio40]
set_property PULLUP true [get_ports pio41]
set_property PULLUP true [get_ports pio42]
set_property PULLUP true [get_ports pio43]
set_property PULLUP true [get_ports pio44]
set_property PULLUP true [get_ports pio45]
set_property PULLUP true [get_ports pio46]
set_property PULLUP true [get_ports pio47]
set_property PULLUP true [get_ports pio48]
