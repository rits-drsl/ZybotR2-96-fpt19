...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "kAXI_InputDataWidth" -parent ${Page_0}
  ipgui::add_param $IPINST -name "kAXI_OutputDataWidth" -parent ${Page_0}
  ipgui::add_param $IPINST -name "kBayerWidth" -parent ${Page_0}
  ipgui::add_param $IPINST -name "kMaxSamplesPerClock" -parent ${Page_0}
